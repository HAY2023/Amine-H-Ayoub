    ...
    <div className="min-h-screen page-nour text-foreground" dir="rtl">
      ...
      <div className="relative mx-auto max-w-md px-4 py-5 space-y-5">
        ...
        <Section label="التطبيق">
          <Item icon={<Download className="w-5 h-5 text-accent" />} title="تحميل التطبيق لجميع الأجهزة" desc="روابط مباشرة لتحميل نسخة ويندوز، أندرويد، والتلفاز (1.0.1)" onClick={() => setShowDownloads(true)} />
