...
const QUESTIONS: DetectiveQuestion[] = [
  ...
  {
    tag: "سور العقيدة",
    question: "سورة تعدل ثلث القرآن الكريم، من قرأها عشر مرات بنى الله له بيتاً في الجنة؟",
    options: [
      { text: "سورة الإخلاص", icon: "✨", isOdd: true, note: "سورة الإخلاص تعدل ثلث القرآن لأنها أخلصت لصفات الله وتوحيده عز وجل." },
      { text: "سورة الفلق", icon: "🛡️", isOdd: false },
      { text: "سورة الكافرون", icon: "⚔️", isOdd: false },
      { text: "سورة الفاتحة", icon: "📖", isOdd: false },
    ],
    hint: "تبدأ بـ (قُلْ هُوَ اللَّهُ أَحَدٌ)!",
  },
  {
    tag: "أسرار الفاتحة",
    question: "آية في سورة الفاتحة هي الآية الوحيدة التي جمعت بين اسمين من أسماء الله الحسنى مشتقين من الرحمة؟",
    options: [
      { text: "الرَّحْمَٰنِ الرَّحِيمِ", icon: "❤️", isOdd: true, note: "الآية الثالثة: (الرَّحْمَٰنِ الرَّحِيمِ) تجمع بين اسمي الرحمن والرحيم." },
      { text: "الْحَمْدُ لِلَّهِ", icon: "🤲", isOdd: false },
      { text: "مَالِكِ يَوْمِ الدِّينِ", icon: "👑", isOdd: false },
      { text: "إِيَّاكَ نَعْبُدُ", icon: "🧎", isOdd: false },
    ],
    hint: "الآية الثالثة في سورة الفاتحة!",
  },
  {
    tag: "مدن مقدسة",
    question: "سورة من القرآن سميت باسم مدينة إيطالية مشهورة (خطأ شائع)، ما هي حقيقة هذا الاسم؟",
    options: [
      { text: "سورة الروم", icon: "🏛️", isOdd: true, note: "سورة الروم سميت نسبة إلى إمبراطورية الروم البيزنطية، وليس روما الإيطالية." },
      { text: "سورة البندقية", icon: "🛶", isOdd: false },
      { text: "سورة روما", icon: "⚔️", isOdd: false },
      { text: "سورة الكوفة", icon: "🕌", isOdd: false },
    ],
    hint: "تبدأ بـ (الم * غُلِبَتِ الرُّومُ * فِي أَدْنَى الْأَرْضِ)!",
  },
  {
    tag: "حروف مقطعة",
    question: "سورة من القرآن الكريم افتتحت بخمسة أحرف مقطعة (كهيعص)؟",
    options: [
      { text: "سورة مريم", icon: "🌸", isOdd: true, note: "سورة مريم تبدأ بـ (كهيعص)، وهي السورة الوحيدة التي بدأت بهذه الحروف الخمسة." },
      { text: "سورة طه", icon: "🌿", isOdd: false },
      { text: "سورة يس", icon: "❤️", isOdd: false },
      { text: "سورة الشورى", icon: "⚖️", isOdd: false },
    ],
    hint: "سورة تحكي قصة زكريا ويحيى وعيسى ومريم عليهم السلام!",
  },
  {
    tag: "أصحاب الكهف",
    question: "كم لبث أصحاب الكهف في كهفهم نياماً كما ذكر القرآن الكريم؟",
    options: [
      { text: "309 سنين", icon: "⏳", isOdd: true, note: "قال تعالى: (وَلَبِثُوا فِي كَهْفِهِمْ ثَلَاثَ مِائَةٍ سِنِينَ وَازْدَادُوا تِسْعًا)." },
      { text: "100 سنة", icon: "💯", isOdd: false },
      { text: "300 سنة فقط", icon: "🕒", isOdd: false },
      { text: "1000 سنة", icon: "🌌", isOdd: false },
    ],
    hint: "ثلاثمائة وازدادوا تسعاً!",
  },
  {
    tag: "حيوانات مذكورة",
    question: "ما اسم الحيوان الذي نام مع أصحاب الكهف وبسط ذراعيه بالوصيد؟",
    options: [
      { text: "الكلب", icon: "🐕", isOdd: true, note: "قال تعالى: (وَكَلْبُهُم بَاسِطٌ ذِرَاعَيْهِ بِالْوَصِيدِ)." },
      { text: "الذئب", icon: "🐺", isOdd: false },
      { text: "الأسد", icon: "🦁", isOdd: false },
      { text: "القط", icon: "🐈", isOdd: false },
    ],
    hint: "حيوان يُعرف بالوفاء والحراسة!",
  },
  {
    tag: "أطول السور",
    question: "ما هي أطول سورة في القرآن الكريم؟",
    options: [
      { text: "سورة البقرة", icon: "📖", isOdd: true, note: "سورة البقرة هي أطول سور القرآن، وعدد آياتها 286 آية." },
      { text: "سورة آل عمران", icon: "🕌", isOdd: false },
      { text: "سورة الأعراف", icon: "⛰️", isOdd: false },
      { text: "سورة النساء", icon: "🧕", isOdd: false },
    ],
    hint: "تحتوي على آية الكرسي وأطول آية في القرآن (آية الدَّيْن)!",
  },
  {
    tag: "أقصر السور",
    question: "ما هي أقصر سورة في القرآن الكريم؟",
    options: [
      { text: "سورة الكوثر", icon: "💧", isOdd: true, note: "سورة الكوثر هي أقصر سورة وتتكون من 3 آيات و10 كلمات فقط." },
      { text: "سورة العصر", icon: "⏳", isOdd: false },
      { text: "سورة الإخلاص", icon: "✨", isOdd: false },
      { text: "سورة النصر", icon: "🏆", isOdd: false },
    ],
  ...
  {
    tag: "قلب القرآن",
    question: "ما هي السورة التي تُلقب بـ (قلب القرآن)؟",
    options: [
      { text: "سورة يس", icon: "❤️", isOdd: true, note: "قال ﷺ: (إن لكل شيء قلباً، وقلب القرآن يس)." },
      { text: "سورة الرحمن", icon: "🌹", isOdd: false },
      { text: "سورة الملك", icon: "👑", isOdd: false },
      { text: "سورة الفاتحة", icon: "📖", isOdd: false },
    ],
    hint: "تبدأ بحرفين مقطعين هما (ي) و (س)!",
  },
  {
    tag: "عروس القرآن",
    question: "ما هي السورة التي تُلقب بـ (عروس القرآن)؟",
    options: [
      { text: "سورة الرحمن", icon: "🌹", isOdd: true, note: "لكثرة ما فيها من وصف الجنة والنعم والآلاء." },
      { text: "سورة مريم", icon: "🌸", isOdd: false },
      { text: "سورة طه", icon: "🌿", isOdd: false },
      { text: "سورة النور", icon: "💡", isOdd: false },
    ],
    hint: "فيها آية تتكرر 31 مرة: (فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ)!",
  },
  {
    tag: "أول مانزل",
    question: "ما هي أول آيات نزلت من القرآن الكريم على النبي ﷺ في غار حراء؟",
    options: [
      { text: "اقْرَأْ بِاسْمِ رَبِّكَ", icon: "📖", isOdd: true, note: "أول خمس آيات من سورة العلق هي أول ما نزل من القرآن." },
      { text: "يَا أَيُّهَا الْمُدَّثِّرُ", icon: "🧥", isOdd: false },
      { text: "الْحَمْدُ لِلَّهِ", icon: "🤲", isOdd: false },
      { text: "قُلْ هُوَ اللَّهُ أَحَدٌ", icon: "✨", isOdd: false },
    ],
    hint: "أمر من الملك جبريل للنبي ﷺ بالقراءة!",
  },
  {
    tag: "أشجار مذكورة",
    question: "شجرة مباركة ذُكرت في القرآن يُوقد من زيتها، ما هي؟",
    options: [
      { text: "شجرة الزيتون", icon: "🫒", isOdd: true, note: "قال تعالى: (يُوقَدُ مِن شَجَرَةٍ مُّبَارَكَةٍ زَيْتُونَةٍ لَّا شَرْقِيَّةٍ وَلَا غَرْبِيَّةٍ)." },
      { text: "شجرة النخيل", icon: "🌴", isOdd: false },
      { text: "شجرة التين", icon: "🍈", isOdd: false },
      { text: "شجرة السدر", icon: "🌳", isOdd: false },
    ],
    hint: "ذُكرت في سورة النور في آية (اللَّهُ نُورُ السَّمَاوَاتِ وَالْأَرْضِ)!",
  },
  {
    tag: "أنبياء صغار",
    question: "من هو النبي الذي آتاه الله الحكم والعلم والنبوة وهو صبي صغير؟",
    options: [
      { text: "يحيى عليه السلام", icon: "👶", isOdd: true, note: "قال تعالى: (يَا يَحْيَىٰ خُذِ الْكِتَابَ بِقُوَّةٍ ۖ وَآتَيْنَاهُ الْحُكْمَ صَبِيًّا)." },
      { text: "يوسف عليه السلام", icon: "👑", isOdd: false },
      { text: "عيسى عليه السلام", icon: "✨", isOdd: false },
      { text: "إسماعيل عليه السلام", icon: "🕋", isOdd: false },
    ],
    hint: "هو ابن زكريا عليهما السلام، وقد ذُكر في سورة مريم!",
  }
];
