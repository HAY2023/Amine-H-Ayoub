...
const options = {
    ...
    path: '/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png',
    headers: {
        'User-Agent': 'Node.js Script (https://github.com/nodejs/node)'
    }
};
...
https.get(options, (res) => {
    ...
    fileStream.on('finish', () => {
        ...
        console.log('git commit -m "fix: replace fake PNG with genuine PNG binary for tauri icon"');
